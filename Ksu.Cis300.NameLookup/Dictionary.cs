    ...
    public class Dictionary<TKey, TValue> where TKey : IComparable<TKey>
    {
        ...
        private static BinaryTreeNode<KeyValuePair<TKey, TValue>> Remove(TKey key, BinaryTreeNode<KeyValuePair<TKey, TValue>> t, out bool removed)
        {
            ...
            if (compare < 0)
            {
                ...
                BinaryTreeNode<KeyValuePair<TKey, TValue>> updatedTree = new BinaryTreeNode<KeyValuePair<TKey, TValue>>(t.Data, t.LeftChild, rightUpdate);
                return updatedTree;
            }
            ...
            else if (compare > 0)
            {
                ...
                BinaryTreeNode<KeyValuePair<TKey, TValue>> updatedTree = new BinaryTreeNode<KeyValuePair<TKey, TValue>>(t.Data, leftUpdate, t.RightChild);
                return updatedTree;
            ...
            public bool Remove(TKey k)
            {
                CheckKey(k);
                bool isRemoved;
                _elements = Remove(k, _elements, out isRemoved);
                return isRemoved;
